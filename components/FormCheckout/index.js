    ...
    <form action='' className='container form-semina'>
      <div className='personal-details'>
        ...
        <div className='row row-cols-lg-8 row-cols-md-2 row-cols-12 justify-content-center'>
          ...
          <div class="qty mt-5">
            <h5>Tickets</h5>
            <Button variant="minus bg-dark" action={()=> setTotalTickets(totalTickets - 1)}> - </Button>
              <input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" value={totalTickets}/>
            <Button variant="plus bg-dark" action={()=> setTotalTickets(totalTickets + 1)}> + </Button>
          </div>
        </div>
      </div>
